...
<!-- A logo to be added here -->
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-8" id="signup_msg_">
				<?php
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					...
					<form method="post" action="register.php" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-12">
								<label for="profile_pic">Picha:</label>
						...
						<div class="row">
							<div class="col-md-12">
								<input style="float:right;" value="Jisajili" type="submit" id="signup_button_" name="signup_button" class="btn btn-success btn-md">
							</div>
						</div>
